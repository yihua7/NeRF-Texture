...
def get_encoder(encoding, input_dim=3, 
    ...
    elif encoding == 'hashgrid_clustering':
        from gridencoder import GridEncoder_clustering
        encoder = GridEncoder_clustering(input_dim=input_dim, num_levels=num_levels, level_dim=level_dim, base_resolution=base_resolution, log2_hashmap_size=log2_hashmap_size, desired_resolution=desired_resolution, gridtype='hash', align_corners=align_corners)
